...
async function getClientFromSession(username) {
  ...
  try {
    ...
    Object.entries(state.cookies).forEach(([key, value]) => {
      jar.setCookieSync(
    ...
    console.log('[ig_client] Cookies injected successfully');

    // 🔥 Set user id manually (IMPORTANT)
